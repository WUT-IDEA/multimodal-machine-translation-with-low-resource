    ...
    def create_reference_files(self):
        ...
        for (lang1, lang2), v in data.items():
            ...
            for data_set in ['valid', 'test']:
                ...
                # convert to text
                if params.mmt_steps or params.vbt_steps:
    ...
    def run_all_evals(self, trainer):
        ...
        with torch.no_grad():
            ...
            for data_set in ['valid', 'test']:
                ...
                for lang1, lang2 in set(params.mmt_steps + [(l2, l3) for _, l2, l3 in params.vbt_steps]):
                    eval_bleu = params.eval_bleu and params.is_master
    ...
    def evaluate_mmt(self, scores, data_set, lang1, lang2, eval_bleu):
        ...
        for batch in self.get_iterator(data_set, lang1, lang2):
            ...
            if eval_bleu:
                max_len = int(1.5 * len1.max().item() + 10)
                if params.beam_size == 1:
                    generated, lengths = decoder.generate(enc1, len1 + params.num_of_regions,
