...
try:
    from fairseq.model_parallel.megatron.mpu import (get_data_parallel_rank, get_data_parallel_world_size,
...
class MegatronTrainer(Trainer):
    ...
    def load_checkpoint(self, filename, reset_optimizer=False, reset_lr_scheduler=False, optimizer_overrides=None,
                        reset_meters=False):
        extra_state = super().load_checkpoint(filename, reset_optimizer=reset_optimizer,
