...
class FairseqCriterion(_Loss):
    ...
    def build_criterion(cls, cfg: FairseqDataclass, task):
        ...
        for p in inspect.signature(cls).parameters.values():
            ...
            if p.name == "task":
                ...
                raise NotImplementedError("Unable to infer Criterion arguments, please implement "
    ...
    def aggregate_logging_outputs(logging_outputs: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        utils.deprecation_warning("The aggregate_logging_outputs API is deprecated. "
    ...
    def reduce_metrics(cls, logging_outputs: List[Dict[str, Any]]) -> None:
        """Aggregate logging outputs from data parallel training."""
        utils.deprecation_warning("Criterions should implement the reduce_metrics API. "
...
class LegacyFairseqCriterion(FairseqCriterion):
    def __init__(self, args, task):
        ...
        utils.deprecation_warning("Criterions should take explicit arguments instead of an "
