...
from .fairseq_model import (BaseFairseqModel, FairseqEncoderDecoderModel, FairseqEncoderModel,
                            FairseqLanguageModel, FairseqModel, FairseqMultiModel)
...
__all__ = ["BaseFairseqModel", "CompositeEncoder", "DistributedFairseqModel", "FairseqDecoder",
           "FairseqEncoder", "FairseqEncoderDecoderModel", "FairseqEncoderModel",
           "FairseqIncrementalDecoder", "FairseqLanguageModel", "FairseqModel", "FairseqMultiModel"]
...
def build_model(cfg: FairseqDataclass, task, from_checkpoint=False):
    ...
    if not model_type and len(cfg) == 1:
        ...
        if model_type in MODEL_DATACLASS_REGISTRY:
            ...
            raise Exception("Could not infer model type from directory. Please add _name field to indicate model type."
                            "Available models: " + str(MODEL_DATACLASS_REGISTRY.keys()) + " Requested model type: "
                            + model_type)
