...
class RGGATEEncoderBase(FairseqEncoder):
    ...
    def __init__(self, cfg, dictionary, embed_tokens, return_fc=False):
        ...
        self.attacker = Attack(embed_dim=cfg.decoder_embed_dim, num_heads=cfg.decoder_attention_heads,
                               dropout=cfg.attention_dropout)
    ...
    def forward(self, src_tokens, src_lengths: Optional[torch.Tensor] = None,
                ...
                token_embeddings: Optional[torch.Tensor] = None, loss_type: str = 'nmt'):
    ...
    def forward_scriptable(self, src_tokens, src_lengths: Optional[torch.Tensor] = None,
                           ...
                           grid_img_features=None, region_img_features=None, loss_type='nmt'):
        """
        Args:
            src_tokens (LongTensor): tokens in the source language of shape
                `(batch, src_len)`
        ...
        merge, _, _ = self.merge_attn(query=x, key=img_feat, value=img_feat, key_padding_mask=region_img_mask,
