...
class RGANNDecoder(TransformerDecoder):
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        return RGANNDecoderLayer(args, no_encoder_attn)
    ...
    def forward(self, prev_output_tokens, encoder_out: Optional[EncoderOut] = None,
        ...
        x, extra = self.extract_features(prev_output_tokens, encoder_out=encoder_out,
                                         ...
                                         loss_type=loss_type, new_weight=self.weight)
    ...
    def extract_features(self, prev_output_tokens, encoder_out: Optional[EncoderOut] = None,
                         ...
                         alignment_heads: Optional[int] = None, loss_type: str = 'nmt', new_weight: float = 1.0):
...
class RGANNDecoderLayer(TransformerDecoderLayer):
    ...
    def forward(self, x, encoder_out: Optional[torch.Tensor] = None,
                ...
                self_attn_padding_mask: Optional[torch.Tensor] = None, need_attn: bool = False,
                need_head_weights: bool = False, attacker=None, loss_type: str = 'nmt',
                new_weight: float = 1.0):
        """
        Args:
        ...
        if self.encoder_attn is not None:
            ...
            x, attn = self.encoder_attn(query=x, key=encoder_out, value=encoder_out,
                                        ...
                                        need_head_weights=need_head_weights, mask=mask,
                                        loss_type=loss_type, new_weight=new_weight)
    ...
    def forward(self, query, key: Optional[Tensor], value: Optional[Tensor],
        ...
        if need_weights:
            ...
            if loss_type == 'nmt':
                ...
                print('attn-we', attn_weights.size())
                print(attn_weights)
