...
ANNEAL_ROOT=$ACMMT_ROOT/examples/rgmmt
...
fairseq-generate ${ACMMT_ROOT}/data_bin/$SRC-$TGT/${TEST} --user-dir ${ANNEAL_ROOT} --batch-size 128 \
        --criterion label_smoothed_cross_entropy --task rgmmt_translation_task \
