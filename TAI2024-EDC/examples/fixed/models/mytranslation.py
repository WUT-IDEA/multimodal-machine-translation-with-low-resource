...
@register_model('attack_transformer')
class AttackTransformerModel(TransformerModel):
    def __init__(self, args, encoder, decoder):
        super().__init__(args, encoder, decoder)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return AttackTransformerDecoder(args, tgt_dict, embed_tokens,
...
@register_model_architecture('attack_transformer', 'my_arch')
