...
from .encoder import RGGATEEncoder
from .decoder import RGGATEDecoder
from fairseq.models.transformer import (TransformerModel, base_architecture, TransformerDecoder)


@register_model("rggate_transformer")
class RGMMTTModel(TransformerModel):
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return RGGATEEncoder(cfg, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return RGGATEDecoder(args, tgt_dict, embed_tokens,
...
@register_model_architecture('rggate_transformer', 'rggate_model')
