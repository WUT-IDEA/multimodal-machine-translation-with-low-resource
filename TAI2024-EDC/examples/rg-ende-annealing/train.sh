...
RGMMT_ROOT=$ACMMT_ROOT/examples/rg-ende-annealing


export CUDA_VISIBLE_DEVICES=1

 fairseq-train ${ACMMT_ROOT}/data_bin/$SRC-$TGT \
        --user-dir ${RGMMT_ROOT} --criterion rgann_criterion \
        --task rgann_translation_task --arch rgann_model --optimizer rgann_adam --adam-betas 0.9,0.98 \
