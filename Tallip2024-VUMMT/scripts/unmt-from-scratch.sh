...
python ../train.py  --beam_size 8 --exp_name unmt-scratch-${SRC}-${TGT}  --dump_path ${DUMP_PATH} \
    ...
    --tokens_per_batch 2000 --batch_size 64  --bptt 256 --emb_dim 512  --n_layers 6  --n_heads 8  \
